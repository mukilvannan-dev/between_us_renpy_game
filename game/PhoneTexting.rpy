...
define MC_Name = "Ren" ##The name of the main character, used to place them on the screen
...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "phone text/phone_send_frame.png"
            else:
                $ message_frame = "phone text/phone_received_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "phone text/ren_pfp.png"
                    elif d.who == "Reina":
                        $ message_icon = "phone text/reina_pfp.png"
                    elif d.who == "Aira":
                        $ message_icon = "phone text/aira_pfp.png"
                    else:
                        $ message_icon = "phone text/kuroha_pfp.png"
...
style phoneFrame_frame:
    background Transform("phone text/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("phone text/phone_foreground.png", xcenter=0.5,yalign=0.5)
